...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_20_0_HMAC_set_precomputed_key_export"]
    pub fn HMAC_set_precomputed_key_export(ctx: *mut HMAC_CTX) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_20_0_HMAC_get_precomputed_key"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_20_0_HMAC_Init_from_precomputed_key"]
...
extern "C" {
    #[link_name = "\u{1}_aws_lc_0_20_0_KBKDF_ctr_hmac"]
