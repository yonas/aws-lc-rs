...
pub const ERR_R_FIPS_TEST_FAILURE: i32 = 70;
...
pub const ERR_LIB_FIPS: _bindgen_ty_1 = 34;
...
extern "C" {
    #[link_name = "\u{1}aws_lc_fips_0_9_0_FIPS_service_indicator_before_call"]
    pub fn FIPS_service_indicator_before_call() -> u64;
}
extern "C" {
    #[link_name = "\u{1}aws_lc_fips_0_9_0_FIPS_service_indicator_after_call"]
    pub fn FIPS_service_indicator_after_call() -> u64;
}
extern "C" {
    #[link_name = "\u{1}aws_lc_fips_0_9_0_awslc_version_string"]
